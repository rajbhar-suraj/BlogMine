...
export const BlogContextProvider = ({ children }) => {
    ...
    const fetchUserBlogs = async () => {
        try {
            const res = await axios.get('http://localhost:5000/auth/blog/myblogs', {
    ...
    const createBlogs = async (formData) => {
        setLoading(true);
        try {
            const res = await axios.post('http://localhost:5000/auth/blog/create', formData, {
                withCredentials: true,
                headers: {
    ...
    const editBlog = async (formData, id) => {
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:5000/auth/blog/edit/${id}`, formData, {
                headers: {
    ...
    const deleteBlog = async (id) => {
        ...
        try {
            const res = await axios.delete(`http://localhost:5000/auth/blog/delete/${id}`, { withCredentials: true })
            await getAllBlogs()
            refreshBlogs()
    ...
    const likeBlogsDashboard = async (blogId) => {
        ...
        try {
            const res = await axios.post(`http://localhost:5000/auth/blog/${blogId}/like`, {}, { withCredentials: true });
    ...
    const likeBlogs = async (id) => {
        ...
        try {
            const res = await axios.post(`http://localhost:5000/auth/blog/${id}/like`, {}, { withCredentials: true });
    ...
    const fetchComment = async (id) => {
        ...
        try {
          const res = await axios.get(`http://localhost:5000/auth/blog/fetchComment/${id}`, {
            withCredentials: true
          });
    ...
    const addComment = async (comment, id) => {
        ...
        const text = comment
        try {
            const res = await axios.post(`http://localhost:5000/auth/blog/addComment/${id}`, { text }, { withCredentials: true })
    ...
    const editComment = async (blogId, commentId, newText) => {
        try {
            const res = await axios.put(
                `http://localhost:5000/auth/blog/editComment/${blogId}/${commentId}`,
                { text: newText },
                { withCredentials: true }
            );
            setComments(prev =>
    ...
    const deleteComment = async (blogId, commentId) => {
        try {
            const res = await axios.delete(`http://localhost:5000/auth/blog/deleteComment/${blogId}/${commentId}`, {
                withCredentials: true
            });
    ...
    const bookMarks = async (blogId) => {
        ...
        try {
            const res = await axios.post(`http://localhost:5000/auth/blog/bookmarks/${blogId}`, {}, { withCredentials: true })
    ...
    const fetchSavedBlogs = async () => {
        try {
            const res = await axios.get('http://localhost:5000/auth/blog/saved-blogs', { withCredentials: true });
