...
const UserProfile = () => {
  ...
  async function saveHandler() {
    try {
      const res = await axios.put(`http://localhost:5000/auth/userprofile/${user._id}`, userData, { withCredentials: true })
    ...
    <div className='bg-gray-100 min-h-screen'>
      ...
      <div className='flex justify-center px-4 h-[60vh]'>
        <div className='w-full max-w-6xl rounded-md bg-zinc-800 text-white px-6 py-8 relative flex flex-col md:flex-row items-center gap-6'>
          ...
          {/* Profile Icon */}
          <div className='flex justify-center items-center bg-black rounded-full h-30 w-30'>
